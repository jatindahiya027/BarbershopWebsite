...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-dark">Services</h1>
            ...
            <?php
                ...
                ?>
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="services.php?do=Add" class="btn btn-success btn-sm" style="margin-bottom: 10px;background-color: #EEB365;border-color:#EEB365">
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Add New Service</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Add">
                                ...
                                <button type="submit" name="add_new_service" class="btn text-dark"style="background-color:#EEB365;border-color:#EEB365;">Add service</button>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="services.php?do=Edit&service_id=<?php echo $service_id; ?>">
                                        ...
                                        <!-- SUBMIT BUTTON -->
                                        <button type="submit" name="edit_service_sbmt" class="btn text-dark"style="background-color:#EEB365;border-color:#EEB365;">Save Edits</button>
                                    </form>
