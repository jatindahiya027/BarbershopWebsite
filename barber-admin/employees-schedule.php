        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold  text-dark">Employees Schedule</h6>
                </div>
                <div class="card-body">
                    <div class="sb-entity-selector" style="max-width:300px;">
                        <form action="employees-schedule.php" method="POST">
                            <div class="form-group">
                                ...
                                <button type="submit" name="show_schedule_sbmt" class="btn btn-primary"style="background-color:#EEB365;border-color:#EEB365;">Show schedule</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="sb-content" style="min-height: 500px;">
                        ...
                        ?>
                                <form method="POST" action="employees-schedule.php">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="save_schedule_sbmt" class="btn btn-info text-dark"style="background-color:#EEB365;border-color:#EEB365;">Save schedule</button>
                                    </div>
                                </form>
                        <?php
                            }
