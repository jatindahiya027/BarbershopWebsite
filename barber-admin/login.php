...
<html lang="en">
	<head>
		...
		<link rel="icon" href="../Design/images/logo_title.png" type="image/icon type">
		<!-- FONTS FILE -->
	...
	<body>
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
				...
				<p>
					<button type="submit" name="signin-button" style="background-color: #EEB365;color:black;font-weight:bold">Sign In</button>
