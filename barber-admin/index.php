...
?>
	...
	<div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header tab" style="padding: 0px !important;background: black!important">
            	<button class="tablinks active" onclick="openTab(event, 'Upcoming')"style="background-color: black;">
            		Upcoming Bookings
            	</button>
                <button class="tablinks" onclick="openTab(event, 'All')"style="background-color: black;">
                	All Bookings
                </button>
                <button class="tablinks" onclick="openTab(event, 'Canceled')"style="background-color: black;">
                	Canceled Bookings
                </button>
            </div>
            <div class="card-body">
