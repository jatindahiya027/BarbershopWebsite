                    ...
                    ?>
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="employees.php?do=Add" class="btn btn-success btn-sm" style="margin-bottom: 10px;background-color:#EEB365;border-color:#EEB365">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="employees.php?do=Edit&employee_id=<?php echo $employee_id; ?>">
                                        ...
                                        <!-- SUBMIT BUTTON -->
                                        <button type="submit" name="edit_employee_sbmt" class="btn text-dark"style="background-color:#EEB365;border-color:#EEB365;">
                                            Edit employee
                                        </button>
                                    </form>
                                    <?php
